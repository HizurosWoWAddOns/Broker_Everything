...
if LOCALE_deDE then
	...
	L["%s found. It's unsave to hide the minimap mail icon without errors."] = "%s gefunden. Es ist unsicher, das Minimap Post Symbol zu verstecken ohne Fehlermeldungen.";
	L["%s found. It's unsave to hide the minimap tracking icon without errors."] = "%s gefunden. Es ist unsicher, das Minimap Aufspüren Symbol zu verstecken ohne Fehlermeldungen.";
	L["%s has a similar option to hide the minimap mail icon."] = "%s hat eine vergleichbare Option zum verstecken des Minimap Post Symbols.";
	L["%s has a similar option to hide the minimap tracking icon."] = "%s hat eine vergleichbare Option zum verstecken des Minimap Aufspüren Symbols.";
	L["%s has its own mail icon."] = "%s hat sein eigenes Post Symbol.";
	L["%s has its own tracking icon."] = "%s hat sein eigenes Aufspüren Symbol.";
	L["(Unknown)"] = "(unbekannt)";
	L["(current)"] = "(aktuell)";
	L["(finished)"] = "(erledigt)";
	L["(session only)"] = "(nur Sitzung)";
	L["(soon)"] = "(bald)";
	L["1. Sort your characters"] = "1. Sortiere deine Charaktere";
	L["2. Delete character data"] = "2. Lösche Charakterdaten";
	L["<<empty>>"] = "<<leer>>";
	...
	L["Hide all entries with 'Demote' as action."] = "Versteckealle Einträge mit 'Degradiert' als Aktion";
	L["Hide all entries with 'Invite' as action."] = "Verstecke alle Einträge mit 'Eingeladen' als Aktion";
	L["Hide all entries with 'Join' as action."] = "Verstecke alle Einträge mit 'Beigetreten' als Aktion";
	L["Hide all entries with 'Leave' as action."] = "Verstecke alle Einträge mit 'Verlässt' als Aktion";
	L["Hide all entries with 'Promote' as action."] = "Verstecke alle Einträge mit 'Befördert' als Aktion";
	L["Hide all entries with 'Remove' as action."] = "Verstecke alle Einträge mit 'Entfernt' als Aktion";
	-- L["Hide blizzard's tracking button on minimap"] = "";
	L["Hide calendar button"] = "Verst. Kalender Button";
	L["Hide copper"] = "Verstecke Kupfer";
	-- L["Hide copper and silver values of your money"] = "";
	-- L["Hide copper values of your money"] = "";
	L["Hide demotions"] = "Verstecke Degradierungen";
	L["Hide disabled followers"] = "Verstecke deaktivierte Anhänger";
	L["Hide disabled followers in tooltip"] = "Verstecke deaktivierte Anhänger im Tooltip";
	L["Hide invites"] = "Verstecke Einladungen";
	L["Hide joins"] = "Verstecke Beitritte";
	-- L["Hide leaves"] = "";
	-- L["Hide lower zero values of your money"] = "";
	-- L["Hide lower zeros"] = "";
	-- L["Hide minimap button"] = "";
	-- L["Hide minimap mail icon"] = "";
	L["Hide promotions"] = "Verstecke Beförderungen";
	-- L["Hide removes"] = "";
	-- L["Hide section 2"] = "";
	...
	-- L["Hide silver"] = "";
	L["Hide working followers"] = "Verstecke arbeitende Anhänger";
	L["Hide working followers in tooltip"] = "Verstecke arbeitende Anhänger im Tooltip";
	...
	L["Opens a little menu with 3 reset options"] = "Öffnet kleines Menü mit 3 Zurücksetz-Optionen";
	L["Options"] = "Optionen";
	L["Order archaeology races by continent"] = "Ordne Archaeologie-Rassen nach Kontinent";
	L["Order by continent"] = "Ordnen nach Kontinent";
	-- L["Out of Level"] = "";
	...
	L["Remove the currency"] = "Entferne das Abzeichen";
	L["Removed"] = "Entfernt";
	L["Rep"] = "Ruf";
	...
	L["Reset last repairs"] = "Zurücksetzen der letzten Reparaturen";
	...
	-- L["Show GMTicket"] = "Zeige GM Ticket";
	...
	L["Show all factions"] = "Zeige alle Fraktionen";
	L["Show all realms"] = "Zeige alle Realms";
	L["Show applicants"] = "Zeige Bewerbungen";
	L["Show applicants in broker and tooltip"] = "Zeige Bewerbungen im Broker und im Tooltip";
	L["Show archievements"] = "Zeige Erfolge";
	L["Show available missions"] = "Zeige verfügbare Missionen";
	L["Show available missions in tooltip"] = "Zeige verfügbare Missionen im Tooltip";
	L["Show average item level"] = "Zeige durchschnittliche Gegenstandsstufe";
	L["Show bagspace instead used and max. bagslots in broker button"] = "Zeige Taschenplatz statt belegt und max. Taschenplätze im Broker Button";
	L["Show blueprints"] = "Zeige Baupläne";
	L["Show cache forcast"] = "Zeige Lagervorhersage";
	L["Show cache forcast in title"] = "Zeige Lagervorhersage im Title";
	L["Show characters"] = "Zeige Charaktere";
	L["Show characters from all factions in tooltip."] = "Zeige Charaktere von allen Fraktionen im Tooltip.";
	L["Show characters from all realms in tooltip."] = "Zeige Charaktere von allen Realms im Tooltip.";
	...
	L["Show difference"] = "Zeige Unterschied";
	L["Show difference of last change in tooltip"] = "Zeige Unterschied zur letzten Änderung im Tooltip";
	L["Show dig site status"] = "Zeige Status des Ausgrabungsorts";
	L["Show dig site status in broker button."] = "Zeige Status des Ausgrabungsorts im Broker Button";
	-- L["Show discount"] = "";
	-- L["Show favorites only in tooltip"] = "";
	-- L["Show followers on missions"] = "";
	-- L["Show freespace"] = "";
	-- L["Show group member name with same quests"] = "";
	L["Show guild reputation"] = "Zeigen Gildenruf";
	...
	L["Show mobile chatter"] = "Zeige mobile Chatter";
	L["Show mobile chatter in broker"] = "Zeige mobile Chatter im Broker";
	L["Show mobile chatter in tooltip (Armory App users)"] = "Zeige mobile Chatter im Tooltip (Arsenal App Nutzer)";
	...
	L["Show professions from guild member"] = "Zeige Berufe vom Gildenmitglied";
	L["Show professions from guild members"] = "Zeige Berufe vom Gildenmitgliedern";
	...
	L["of"] = "von";
	L["open the calendar"] = "Öffne den Kalender";
	L["open the character info"] = "Öffne die Charakteransicht";
	L["open the guild roster"] = "Öffne das Gildenfenster";
	L["open the option menu"] = "Öffne das Optionenmenü";
	-- L["open the time manager"] = "";
	L["open your archaeology frame"] = "Öffne das Archaeologiefenster";
	-- L["open your bags"] = "";
	-- L["poor and common"] = "";
